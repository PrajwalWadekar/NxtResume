...
const StepProgress = ({progress}) => {
  return (
    ...
    border border-white/10">
        ...
        rounded-full overflow-hidden animate-pulse-glow" style={{width: `${progress}%`}}>
             ...
             <div className='absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent
                ...
                <div className="absolute inset-0">
                    {[...Array(12)].map((_,i) => (
                        <div key={i} className='absolute w-1 h-1 bg-white/50 rounded-full'
                        style={{
    ...
    <div className="flex justify-between items-center mt-3 ">
        ...
        progress <75 ? "Almost There":"Nearly Completed"}
        </div>

        <div className="flex items-center gap-2">
            {progress === 100 && (
                <div className="w-6 h-6 bg-gradient-to-r from-green-500
                to-emerald-500 rounded-full flex items-center justify-center">
