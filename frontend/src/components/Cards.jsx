...
import {Award, Check, TrendingUp,Zap} from 'lucide-react'
...
export const ResumeSummaryCard = ({
  ...
  const formattedUpdatedDate = updatedAt
    ...
    //get color wrt completion status
...
export const TemplateCard = ({thumbnailImage, isSelected, onSelect})=>{
  return(
    <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 
       overflow-hidden cursor-pointer transition-all duration-500 hover:scale-105
       hover:shadow-lg rounded-3xl 
       ${
       ...
       >
        { thumbnailImage ? (
          <div className="relative w-full h-full overflow-hidden">
            <img src={thumbnailImage || '/placeholder.svg'} alt="Template Review" className="w-full h-full 
