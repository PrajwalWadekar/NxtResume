  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
      {/* Header */}
        ...
        p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100">
         ...
         <Tabs tabs={TAB_DATA} activeTab={tabValue} setActiveTab={setTabValue} /> 
          ...
          bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
        <div className="lg:col-span-2 bg-white rounded-2xl border border-green-100 p-4 sm:p-6">
