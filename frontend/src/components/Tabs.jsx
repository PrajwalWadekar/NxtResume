    ...
    <div className='w-full my-2'>
      <div className="flex flex-wrap bg-violet-50 p-1 rounded-2xl border border-violet-100">
        {tabs.map((tab)=>(
          ...
          className={`relative flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3
            ...
            onClick={()=>setActiveTab(tab.label)}>
              <span className="relative z-10">
                ...
                {activeTab === tab.label && (
                  <div className="absloute inset-0 bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 rounded-xl">
