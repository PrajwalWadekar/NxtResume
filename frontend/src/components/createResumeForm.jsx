  ...
  return (
    <div className='w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg'>
      ...
      <p className="text-gray-600 mb-8">
        Give your resume a title to get started. You can customize everything late
      </p>
      ...
      <form onSubmit={handleCreateResume}>
        ...
        text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl
        hover:shadow-rose-200 transition-all'>
          Create Resume
        </button>
      </form>
    </div>
