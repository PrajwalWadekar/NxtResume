...
import { ArrowLeft, AlertCircle, Download, Palette, Save, Trash2, Check, Loader2, PaletteIcon } from "lucide-react";
...
import { ProfileInfoForm,ContactInfoForm, AdditionalInfoForm, CertificationInfoForm, EducationDetailsForm, ProjectDetailForm,SkillsInfoForm,WorkExperienceForm } from "./Forms";
...
const EditResume = () => {
  ...
  //help us choose the preview and with downloading resume and save it as a new img
   ...
   const updateResumeDetails = async (thumbnailLink) => {
    try {
      ...
      //deelete function to delete a resume
    ...
    //type of how it will look while downloading
    try {
      await html2pdf()
        .set({
          margin:       0,
